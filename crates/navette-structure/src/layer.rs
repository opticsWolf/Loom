...
use crate::enums::{LayerType, RoughnessType};
...
impl_serde_int!(crate::enums::ErrorType);
impl_serde_int!(crate::enums::RoughnessType);
impl_serde_int!(crate::enums::ErrorMask);
impl_serde_int!(crate::enums::LayerMask);
impl_serde_int!(crate::enums::OptMask);
impl_serde_int!(crate::enums::LayerType);
impl_serde_int!(crate::enums::BlockKind);
